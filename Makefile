...
deploy:
	...
	@echo "📊 Uploading feature schema files..."
	huggingface-cli upload firmnnm/Tugas1MLOps ./Model/feature_names.json Model/feature_names.json --repo-type=space --commit-message="Upload feature names JSON" || echo "⚠️ feature_names.json not found"
	huggingface-cli upload firmnnm/Tugas1MLOps ./Model/feature_schema.json Model/feature_schema.json --repo-type=space --commit-message="Upload feature schema" || echo "⚠️ feature_schema.json not found"
	@echo "🔧 Uploading feature validator utility..."
	huggingface-cli upload firmnnm/Tugas1MLOps ./feature_validator.py feature_validator.py --repo-type=space --commit-message="Upload feature validator utility" || echo "⚠️ feature_validator.py not found"
